...
public:
  ...
  static const unsigned int PIVOT_Y =
      1; //< pivot Y coord in the Tetrimino_Pieces matrix
  static const unsigned int PIVOT_X =
      2; //< pivot X coord ine the Tetrimino_Pieces matrix

  enum Tetrimino_Types {
    O = 0,
    I,
    S,
    Z,
    ...
    T,
    SIZE
  }; //< different kind of pieces
  static const sf::Color
      Tetrimino_colors[Tetrimino_Types::SIZE]; //< different colors for each
                                               //kind of piece
  static const char
      Tetrimino_Pieces[Tetrimino_Types::SIZE][NB_ROTATIONS][MATRIX_SIZE]
                      [MATRIX_SIZE]; //< store all the different shapes
